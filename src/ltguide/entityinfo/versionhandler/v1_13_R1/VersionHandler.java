package ltguide.entityinfo.versionhandler.v1_13_R1;
...
import org.bukkit.craftbukkit.v1_13_R1.entity.CraftMonster;
		...
		while (distance < EntityInfo.maxDistance) {
			for (Object object : worldServer.getEntities(entityPlayer, bBox)) {
				if (object instanceof EntityLiving) {
					Entity entity = ((net.minecraft.server.v1_13_R1.Entity) object).getBukkitEntity();
